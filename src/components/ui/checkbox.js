...
const Checkbox = ({
    ...
    return (
        <CheckboxRoot.Root
            ...
            className={mergeClasses(baseCheckboxStyles({ variant, size, disabled }), className)}>
            <CheckboxRoot.Indicator className={mergeClasses(baseCheckboxIndicatorStyles({ variant, size }))}>
                <BiCheck />
