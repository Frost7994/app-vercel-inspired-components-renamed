      ...
      compoundVariants: [
        {
          variant: "default",
          enabled: true,
          className: ["bg-tertiary-400", "dark:bg-tertiary-700"],
        },
        {
          variant: "primary",
          enabled: true,
          className: ["bg-primary-500", "dark:bg-primary-500"],
        },
        {
          variant: "secondary",
          enabled: true,
          className: ["bg-secondary-500", "dark:bg-secondary-500"],
        },
        {
          variant: ["default", "primary", "secondary"],
          enabled: false,
          className: ["bg-tertiary-200", "dark:bg-tertiary-900"],
        },
      ],
      defaultVariants: {
        size: "default",
  ...
  return (
    <Switch
      ...
      className={mergeClasses(
        toggleContainerStyles({ size, enabled, disabled, variant })
      )}
    >
